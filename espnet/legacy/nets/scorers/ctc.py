...
from espnet.legacy.nets.ctc_prefix_score import CTCPrefixScore, CTCPrefixScoreTH
from espnet.legacy.nets.scorer_interface import BatchPartialScorerInterface
    ...
    def __init__(self, ctc: torch.nn.Module, eos: int):
        ...
        Args:
            ctc (torch.nn.Module): The CTC implementation.
                For example, :class:`espnet.legacy.nets.pytorch_backend.ctc.CTC`
