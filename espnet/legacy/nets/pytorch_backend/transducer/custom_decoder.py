...
from espnet.legacy.nets.pytorch_backend.transducer.blocks import build_blocks
from espnet.legacy.nets.pytorch_backend.transducer.utils import (
    check_batch_states,
    check_state,
    pad_sequence,
)
...
from espnet.legacy.nets.transducer_decoder_interface import (
    ExtendedHypothesis,
    Hypothesis,
