...
from espnet.legacy.nets.pytorch_backend.conformer.encoder_layer import (
    EncoderLayer as ConformerEncoderLayer,
)
from espnet.legacy.nets.pytorch_backend.nets_utils import get_activation
from espnet.legacy.nets.pytorch_backend.transducer.conv1d_nets import (
    CausalConv1d,
    Conv1d,
)
from espnet.legacy.nets.pytorch_backend.transducer.transformer_decoder_layer import (
...
from espnet.legacy.nets.pytorch_backend.transformer.embedding import (
    PositionalEncoding,
...
from espnet.legacy.nets.pytorch_backend.transformer.repeat import MultiSequential
