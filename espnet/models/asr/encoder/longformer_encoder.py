...
from espnet.legacy.nets.pytorch_backend.conformer.convolution import ConvolutionModule
from espnet.legacy.nets.pytorch_backend.conformer.encoder_layer import EncoderLayer
from espnet.legacy.nets.pytorch_backend.nets_utils import get_activation, make_pad_mask
...
class LongformerEncoder(ConformerEncoder):
    ...
    def __init__(
        ...
        if selfattention_layer_type == "lf_selfattn":
            ...
            from espnet.legacy.nets.pytorch_backend.transformer.longformer_attention import (  # noqa: E501
                LongformerAttention,
            )
