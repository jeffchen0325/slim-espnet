...
from espnet.models.asr.transducer.error_calculator import ErrorCalculatorTransducer
from espnet.models.asr_transducer.utils import get_transducer_task_io
from espnet.layers.abs_normalize import AbsNormalize
from espnet.legacy.nets.e2e_asr_common import ErrorCalculator
from espnet.legacy.nets.pytorch_backend.nets_utils import th_accuracy
from espnet.legacy.nets.pytorch_backend.transformer.add_sos_eos import add_sos_eos
from espnet.legacy.nets.pytorch_backend.transformer.label_smoothing_loss import (
    LabelSmoothingLoss,
)
    ...
    def __init__(
        ...
        if self.use_transducer_decoder:
            ...
            if not transducer_multi_blank_durations:
                ...
                from espnet.models.asr.transducer.rnnt_multi_blank.rnnt_multi_blank import (
