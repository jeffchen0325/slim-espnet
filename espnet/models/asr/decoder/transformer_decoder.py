...
from espnet.legacy.nets.pytorch_backend.nets_utils import make_pad_mask
from espnet.legacy.nets.pytorch_backend.transformer.attention import (
    MultiHeadedAttention,
)
from espnet.legacy.nets.pytorch_backend.transformer.decoder_layer import DecoderLayer
from espnet.legacy.nets.pytorch_backend.transformer.dynamic_conv import (
    DynamicConvolution,
)
from espnet.legacy.nets.pytorch_backend.transformer.dynamic_conv2d import (
    DynamicConvolution2D,
)
from espnet.legacy.nets.pytorch_backend.transformer.embedding import PositionalEncoding
from espnet.legacy.nets.pytorch_backend.transformer.layer_norm import LayerNorm
from espnet.legacy.nets.pytorch_backend.transformer.lightconv import (
    LightweightConvolution,
)
from espnet.legacy.nets.pytorch_backend.transformer.lightconv2d import (
    LightweightConvolution2D,
)
from espnet.legacy.nets.pytorch_backend.transformer.mask import subsequent_mask
from espnet.legacy.nets.pytorch_backend.transformer.positionwise_feed_forward import (
    PositionwiseFeedForward,
)
from espnet.legacy.nets.pytorch_backend.transformer.repeat import repeat
from espnet.legacy.nets.scorer_interface import (
...
class TransformerDecoder(BaseTransformerDecoder):
    ...
    def __init__(
        ...
        if use_flash_attn:
            try:
                from espnet.torch_utils.get_flash_attn_compatability import (
