...
from espnet.models.gan_tts.vits.duration_predictor import StochasticDurationPredictor
...
from espnet.models.gan_tts.vits.text_encoder import TextEncoder
from espnet.legacy.nets.pytorch_backend.nets_utils import make_non_pad_mask
...
class VITSGenerator(torch.nn.Module):
    ...
    def __init__(
        ...
        # delayed import
        from espnet.models.gan_tts.vits.monotonic_align import maximum_path
