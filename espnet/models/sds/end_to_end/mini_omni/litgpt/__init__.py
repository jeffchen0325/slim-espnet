...
from espnet.models.sds.end_to_end.mini_omni.litgpt.config import Config
from espnet.models.sds.end_to_end.mini_omni.litgpt.model import GPT  # needs to be imported before config
from espnet.models.sds.end_to_end.mini_omni.litgpt.tokenizer import Tokenizer
