...
import espnet.models.sds.end_to_end.mini_omni.litgpt.model
from espnet.models.sds.end_to_end.mini_omni.litgpt.utils import find_multiple
...
class Config:
    ...
    def mlp_class(self) -> Type:
        ...
        return getattr(
            espnet.models.sds.end_to_end.mini_omni.litgpt.model, self.mlp_class_name
        )
    ...
    def norm_class(self) -> Type:
        ...
        if self.norm_class_name == "RMSNorm":
            ...
            from espnet.models.sds.end_to_end.mini_omni.litgpt.model import RMSNorm
