...
from espnet.models.sds.end_to_end.mini_omni.litgpt import Tokenizer
from espnet.models.sds.end_to_end.mini_omni.litgpt.generate.base import (
    generate_AA,
    generate_ASR,
    generate_AT,
    generate_TA,
...
from espnet.models.sds.end_to_end.mini_omni.litgpt.model import GPT, Config
from espnet.models.sds.end_to_end.mini_omni.litgpt.utils import num_parameters  # noqa
from espnet.models.sds.end_to_end.mini_omni.utils.snac_utils import (
    generate_audio_data,
    get_snac,
    get_time_str,
    layershift,
