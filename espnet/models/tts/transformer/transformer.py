...
from espnet.legacy.nets.pytorch_backend.e2e_tts_transformer import (
...
from espnet.legacy.nets.pytorch_backend.tacotron2.decoder import (
    Postnet,
)
from espnet.legacy.nets.pytorch_backend.tacotron2.decoder import (
    Prenet as DecoderPrenet,
)
from espnet.legacy.nets.pytorch_backend.tacotron2.encoder import (
    Encoder as EncoderPrenet,
)
from espnet.legacy.nets.pytorch_backend.transformer.attention import (
    MultiHeadedAttention,
)
from espnet.legacy.nets.pytorch_backend.transformer.decoder import Decoder
from espnet.legacy.nets.pytorch_backend.transformer.embedding import (
    PositionalEncoding,
    ScaledPositionalEncoding,
)
from espnet.legacy.nets.pytorch_backend.transformer.encoder import Encoder
