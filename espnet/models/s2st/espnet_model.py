...
from espnet.legacy.nets.e2e_asr_common import ErrorCalculator as ASRErrorCalculator
from espnet.legacy.nets.e2e_mt_common import ErrorCalculator as MTErrorCalculator
from espnet.legacy.nets.pytorch_backend.nets_utils import make_pad_mask, th_accuracy
from espnet.legacy.nets.pytorch_backend.transformer.add_sos_eos import add_sos_eos
