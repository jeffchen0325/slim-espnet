...
"""Singing Tacotron related modules for espnet3."""
...
from espnet.legacy.nets.pytorch_backend.e2e_tts_tacotron2 import (
    GuidedAttentionLoss,
    Tacotron2Loss,
)
from espnet.legacy.nets.pytorch_backend.nets_utils import make_pad_mask
from espnet.legacy.nets.pytorch_backend.rnn.attentions import (
    AttForward,
    AttForwardTA,
    AttLoc,
    GDCAttLoc,
...
from espnet.models.svs.singing_tacotron.decoder import Decoder
from espnet.models.svs.singing_tacotron.encoder import Duration_Encoder, Encoder
