...
from espnet.models.asr.decoder.hugging_face_transformers_decoder import (
    get_hugging_face_model_lm_head,
    get_hugging_face_model_network,
)
from espnet.models.asr.decoder.s4_decoder import S4Decoder
from espnet.models.asr.partially_AR_model import PartiallyARInference
from espnet.models.asr.transducer.beam_search_transducer import (
    BeamSearchTransducer,
)
from espnet.models.asr.transducer.beam_search_transducer import (
    ExtendedHypothesis as ExtTransHypothesis,
)
from espnet.models.asr.transducer.beam_search_transducer import Hypothesis as TransHypothesis
from espnet.fileio.datadir_writer import DatadirWriter
from espnet.legacy.nets.batch_beam_search import BatchBeamSearch
from espnet.legacy.nets.batch_beam_search_online_sim import BatchBeamSearchOnlineSim
from espnet.legacy.nets.beam_search import BeamSearch, Hypothesis
from espnet.legacy.nets.beam_search_timesync import BeamSearchTimeSync
from espnet.legacy.nets.pytorch_backend.transformer.subsampling import TooShortUttError
from espnet.legacy.nets.scorer_interface import BatchScorerInterface
from espnet.legacy.nets.scorers.ctc import CTCPrefixScorer
from espnet.legacy.nets.scorers.length_bonus import LengthBonus
...
from espnet.tokenizers.build_tokenizer import build_tokenizer
from espnet.tokenizers.hugging_face_token_id_converter import HuggingFaceTokenIDConverter
from espnet.tokenizers.token_id_converter import TokenIDConverter
from espnet.tokenizers.whisper_token_id_converter import OpenAIWhisperTokenIDConverter
from espnet.torch_utils.device_funcs import to_device
...
from espnet.utils.types import str2bool, str2triple_str, str_or_none
...
class Speech2Text:
    ...
    def __init__(
        ...
        if enh_s2t_task:
            try:
                from espnet.tasks.enh_s2t import EnhS2TTask
        ...
        if ngram_file is not None:
            if ngram_scorer == "full":
                from espnet.legacy.nets.scorers.ngram import NgramFullScorer

                ngram = NgramFullScorer(ngram_file, token_list)
            else:
                from espnet.legacy.nets.scorers.ngram import NgramPartScorer
