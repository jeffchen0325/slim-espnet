...
from espnet.tasks.tts2 import TTS2Task
...
def inference(
    ...
    loader = TTS2Task.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=TTS2Task.build_preprocess_fn(text2speech.train_args, False),
        collate_fn=TTS2Task.build_collate_fn(text2speech.train_args, False),
