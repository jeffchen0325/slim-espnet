...
from espnet.fileio.sound_scp import SoundScpReader
from espnet.legacy.utils.cli_utils import get_commandline_args
from espnet.train.dataset import kaldi_loader
...
def scoring(
    ...
    if use_dnsmos:
        if dnsmos_args["mode"] == "local":
            from espnet.models.enh.layers.dnsmos import DNSMOS_local
            ...
            from espnet.models.enh.layers.dnsmos import DNSMOS_web
